...
const AboutPage = () => {
  return (
    <section className="min-h-screen bg-gradient-to-br from-purple-700 via-purple-600 to-blue-600 text-white py-20 px-6 sm:px-12 md:px-24 lg:px-32 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-16 relative z-10">
        ...
        <div className="text-center px-2 mb-20 animate-fade-in">
          <div className="inline-flex items-center gap-2 mb-8 bg-white/10 backdrop-blur-sm px-10 py-4 rounded-full border border-white/20">
            ...
            <span className="text-lg sm:text-xl md:text-2xl font-semibold tracking-wider">
              OFFICIAL INVITATION
            </span>
            <Sparkles className="w-7 h-7 text-yellow-300 animate-pulse" />
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-5 sm:gap-8 text-lg sm:text-xl md:text-2xl font-semibold mt-10">
          ...
          <div className="grid sm:grid-cols-2 gap-10">
            {[
              ...
              <div key={i} className="flex items-start gap-6 group">
                ...
                <div>
                  <p className="text-lg sm:text-xl md:text-2xl uppercase tracking-wider text-gray-300 mb-1">
                    {item.title}
                  </p>
        ...
        <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-md rounded-3xl p-10 sm:p-12 border border-white/20 shadow-xl">
          <div className="flex items-center gap-5 mb-6">
            ...
            <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold">Organized by</h3>
          </div>
          <p className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-blue-100">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-10 sm:p-12 border border-white/20 shadow-2xl">
          <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 flex items-center gap-4">
            <span className="w-2 h-8 bg-gradient-to-b from-yellow-400 to-yellow-600 rounded-full"></span>
            About the Event
          </h3>

          <p className="leading-relaxed mb-6 text-lg sm:text-xl md:text-2xl text-gray-100">
            <strong className="text-white text-xl sm:text-2xl md:text-3xl">AYUBOWAN–ANORA 2026</strong> is a prestigious
          ...
          <p className="leading-relaxed text-lg sm:text-xl md:text-2xl text-gray-100">
        ...
        <div className="bg-gradient-to-br from-purple-600/40 to-blue-600/40 backdrop-blur-lg rounded-3xl p-10 sm:p-12 border border-white/20 shadow-2xl">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              >
                <div className="bg-gradient-to-br from-yellow-400 to-orange-500 text-white font-bold w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 text-lg sm:text-xl md:text-2xl group-hover:scale-110 transition-transform duration-300">
                  {index + 1}
                </div>
